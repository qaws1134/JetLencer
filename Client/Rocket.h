...
public:
	...
	static CGameObject* Create(const OBJECTINFO * _tObjectInfo, _vec3 _vPos, float _fAngle, _vec3 _vSpeed,bool _bMulti);
...
public :
	...
	void	Set_Multi() { m_bMulti = true; }
	void	Set_Sound(bool _bSound) { m_bSound = _bSound; }
